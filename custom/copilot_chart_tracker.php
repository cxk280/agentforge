...
/**
 * Chart Tracker landing page — Figma "Screen 50 — Chart Tracker".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/chart_tracker/. The PHP outer shell
 ...
 *
 * The original static-HTML mock is preserved at copilot_chart_tracker.php.bak
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/chart_tracker/index.tsx'] ?? null;
...
<div class="cp-boot-error">
  <?php echo xlt('Chart Tracker UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
