...
/**
 * Calendar landing page — Figma "Screen 6 — Calendar".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/calendar/. The PHP outer shell at
 ...
 *
 * The original static-HTML mock is preserved at copilot_calendar.php.bak
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/calendar/index.tsx'] ?? null;
...
<div class="cp-boot-error">
  <?php echo xlt('Calendar UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
