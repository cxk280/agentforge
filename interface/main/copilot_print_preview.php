...
/**
 * Print Preview landing page — Figma "Screen 61 — Print Preview".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/print_preview/. The PHP outer shell
 ...
 *
 * The original PHP-rendered mock is preserved at
 * copilot_print_preview.php.bak so a side-by-side screenshot diff remains
 * possible.
 *
 * @package OpenEMR
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/print_preview/index.tsx'] ?? null;
...
<div class="cp-boot-error">
  <?php echo xlt('Print Preview UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
