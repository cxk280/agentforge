...
/**
 * Messages landing page — Figma "Screen 7 — Messages".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/messages/. The PHP outer shell at
 ...
 *
 * The original PHP-rendered mock is preserved at copilot_messages.php.bak
...
// Apache's DocumentRoot in this OpenEMR runtime is the repo root, so the
// /public dir is part of the URL path.
// ---------------------------------------------------------------------------
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/messages/index.tsx'] ?? null;
...
<div class="cp-boot-error">
  <?php echo xlt('Messages UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
