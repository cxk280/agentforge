...
/**
 * Patient Tracker / Flow Board landing page — Figma "Screen 32 — Patient
 * Tracker / Flow Board".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/patient_tracker/. The PHP outer
 ...
 *
 * The original DB-backed mock is preserved at copilot_patient_tracker.php.bak
 * so a side-by-side diff remains possible.
 *
 * @package OpenEMR
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/patient_tracker/index.tsx'] ?? null;
...
<div class="cp-boot-error">
  <?php echo xlt('Patient Tracker UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
