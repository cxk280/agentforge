 ...
 *
 * The original DB-backed PHP page (with onotes table integration and
 * cp_pinned/cp_category/cp_parent_id extension columns) is preserved at
 * copilot_office_notes.php.bak so the prior wiring can be reintroduced
 * once the React port has a real API contract.
 *
 * @package OpenEMR
