...
$sections = [
    [
        ...
        'cards' => [
            ['📋', 'Patient List',          'Filterable cohort export with demographics + active conditions',
                '/interface/reports/copilot_patient_list.php'],
            ...
            ['🧪', 'Lab Trends',            'A1C, lipids, BP across patient panel',
                '/interface/reports/copilot_lab_trends.php'],
    ...
    [
        ...
        'cards' => [
            ...
            ['🏥', 'Patient Flow Board',    'Live status across exam rooms',
                '/interface/main/copilot_patient_tracker.php'],
            ['📈', 'Chart Activity',        'Open vs locked notes, signing turnaround',
                '/custom/copilot_chart_tracker.php'],
        ],
    ],
    [
        'label' => 'FINANCIAL',
    ...
    [
        ...
        'color' => '#8561C7',
        'cards' => [
            ['📤', 'Electronic Submissions', 'CCDA, payer reports, registry exports',
