...
/**
 * Reports landing page — Figma "Screen 8 — Reports".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/reports/. The PHP outer shell at
 ...
 *
 * The original static-HTML mock is preserved at copilot_reports.php.bak
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/reports/index.tsx'] ?? null;
...
<div class="cp-boot-error">
  <?php echo xlt('Reports UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
