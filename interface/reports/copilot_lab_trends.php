...
/**
 * Lab Trends Report — Figma "Screen 45 — Lab Trends Report".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/lab_trends/. The PHP outer shell at
 ...
 *
 * The original PHP-rendered page is preserved at copilot_lab_trends.php.bak
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/lab_trends/index.tsx'] ?? null;
...
<title><?php echo xlt('Lab Trends Report'); ?></title>
...
<div class="cp-boot-error">
  <?php echo xlt('Lab Trends UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
