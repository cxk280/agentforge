...
/**
 * Quality Measures (CQM) landing page — Figma "Screen 46 — Quality Measures (CQM)".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/quality_measures/. The PHP outer
 ...
 *
 * The original DB-backed PHP mock is preserved at
 * copilot_quality_measures.php.bak so a side-by-side screenshot diff
 * remains possible.
 *
 * @package OpenEMR
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/quality_measures/index.tsx'] ?? null;
...
<div class="cp-boot-error">
  <?php echo xlt('Quality Measures UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
