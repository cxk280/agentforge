...
/**
 * Prescription Report landing page — Figma "Screen 44 — Prescription Report".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/prescription_report/. The PHP outer
 ...
 * copilot_prescription_report.php.bak so a side-by-side screenshot diff
 * remains possible.
 *
 * @package OpenEMR
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/prescription_report/index.tsx'] ?? null;
...
<div class="cp-boot-error">
  <?php echo xlt('Prescription Report UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
