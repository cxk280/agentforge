...
/**
 * Electronic Submissions landing page — Figma "Screen 39 — Electronic Reports".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/electronic_reports/. The PHP outer
 ...
 *
 * The original DB-backed PHP implementation (with cp_submissions table seed
 * + POST handlers) is preserved at copilot_electronic_reports.php.bak so a
 * side-by-side screenshot diff remains possible. The React port uses
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/electronic_reports/index.tsx'] ?? null;
...
<div class="cp-boot-error">
  <?php echo xlt('Electronic Reports UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
