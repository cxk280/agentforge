...
/**
 * Admin landing page — Figma "Screen 9 — Admin".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/admin/. The PHP outer shell at
 ...
 *
 * The original static-HTML mock is preserved at copilot_admin.php.bak
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/admin/index.tsx'] ?? null;
...
<div class="cp-boot-error">
  <?php echo xlt('Admin UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
