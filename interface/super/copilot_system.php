...
/**
 * Backup / System Status — Figma "Screen 56 — Backup / System Status".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/system_status/. The PHP outer shell
 * still owns the navy top nav and patient header2 banner; this file only
 * renders inside the #maimain iframe.
 *
 ...
 *
 * The original static-PHP mock is preserved at copilot_system.php.bak
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/system_status/index.tsx'] ?? null;
...
<title><?php echo xlt('System Status'); ?></title>
...
<div class="cp-boot-error">
  <?php echo xlt('System Status UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
