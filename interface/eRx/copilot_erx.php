...
/**
 * e-Rx — Figma "Screen 25 — e-Rx".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/erx/. The PHP outer shell at
 * /interface/main/tabs/main.php still owns the navy top nav and patient
 * demographics banner; this file only renders inside the
 * #maimain iframe.
 *
 ...
 *
 * The original static-HTML mock is preserved at copilot_erx.php.bak
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/erx/index.tsx'] ?? null;
...
<div class="cp-boot-error">
  <?php echo xlt('e-Rx UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
