...
/**
 * e-Rx Renewal landing page — Figma "Screen 41 — e-Rx Renewal".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/erx_renewal/. Static demo: no DB,
 * no POST handlers — the React tree owns all rendering.
 *
 ...
 *
 * The original PHP mock with its full DB-backed queue is preserved at
 * copilot_erx_renewal.php.bak so a side-by-side screenshot diff and
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/erx_renewal/index.tsx'] ?? null;
...
<title><?php echo xlt('e-Rx Renewal'); ?></title>
...
<div class="cp-boot-error">
  <?php echo xlt('e-Rx Renewal UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
