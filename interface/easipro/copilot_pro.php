...
/**
 * Patient Reported Outcomes — Figma "Screen 20 — PRO".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/pro/. The PHP outer shell at
 ...
 *
 * The original static-HTML mock is preserved at copilot_pro.php.bak so a
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/pro/index.tsx'] ?? null;
...
<div class="cp-boot-error">
  <?php echo xlt('PRO UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
