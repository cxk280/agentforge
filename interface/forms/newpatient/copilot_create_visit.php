...
/**
 * Create Visit landing page — Figma "Screen 29 — Create Visit".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/create_visit/. The PHP outer shell at
 ...
 *
 * The original DB-backed PHP mock is preserved at copilot_create_visit.php.bak
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/create_visit/index.tsx'] ?? null;
...
<div class="cp-boot-error">
  <?php echo xlt('Create Visit UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
