...
/**
 * Fee Sheet — Figma "Screen 24 — Fee Sheet".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/fee_sheet/. The PHP outer shell at
 * /interface/main/tabs/main.php still owns the navy top nav and patient
 * header2 banner; this file only renders inside the encounter form iframe.
 *
 ...
 *
 * The original static-HTML mock is preserved at copilot_fee_sheet.php.bak
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/fee_sheet/index.tsx'] ?? null;
...
<div class="cp-boot-error">
  <?php echo xlt('Fee Sheet UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
