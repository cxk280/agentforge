...
/**
 * Batch Results landing page — Figma "Screen 38 — Batch Results".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/batch_results/. The PHP outer shell
 ...
 *
 * The original DB-backed mock is preserved at copilot_batch_results.php.bak
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/batch_results/index.tsx'] ?? null;
...
<div class="cp-boot-error">
  <?php echo xlt('Batch Results UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
