...
/**
 * EDI History landing page — Figma "Screen 67 — EDI History".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/edi_history/. The PHP outer shell at
 ...
 *
 * The upstream OpenEMR EDI History page at
 * /interface/billing/edih_view.php is preserved unmodified; AgentForge routes
 * the "EDI History" menu item to this wrapper instead.
 *
 * @package OpenEMR
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/edi_history/index.tsx'] ?? null;
...
<div class="cp-boot-error">
  <?php echo xlt('EDI History UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
