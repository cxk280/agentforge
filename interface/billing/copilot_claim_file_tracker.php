...
/**
 * Claim File Tracker landing page — Figma "Screen 68 — Claim File Tracker".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/claim_file_tracker/. The PHP outer
 ...
 * parsed in TS by readBootContext().
 *
 * The upstream OpenEMR claim-file tracker at
 * /interface/billing/billing_tracker.php is preserved unmodified; AgentForge
 * routes the "Claim File Tracker" menu item to this wrapper instead.
 *
 * @package OpenEMR
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/claim_file_tracker/index.tsx'] ?? null;
...
<div class="cp-boot-error">
  <?php echo xlt('Claim File Tracker UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
