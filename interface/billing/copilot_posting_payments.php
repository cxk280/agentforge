...
/**
 * Posting Payments landing page — Figma "Screen 66 — Posting Payments".
 *
 * Thin manifest-loading wrapper that hands the page body off to the React
 * bundle built from /frontend/src/pages/posting_payments/. The PHP outer
 ...
 *
 * The upstream OpenEMR EOB-posting page at
 * /interface/billing/sl_eob_search.php is preserved unmodified; AgentForge
 * routes the "Posting Payments" menu item to this wrapper instead.
 *
 * @package OpenEMR
...
$manifest     = is_file($manifestPath)
    ...
    : [];
$entry        = $manifest['src/pages/posting_payments/index.tsx'] ?? null;
...
<title><?php echo xlt('Posting Payments'); ?></title>
...
<div class="cp-boot-error">
  <?php echo xlt('Posting Payments UI bundle not found. Run "npm run build" in the /frontend directory to generate it.'); ?>
</div>
<?php endif; ?>
</body>
</html>
